        ...
        <div className="flex flex-col px-7 pb-24 pt-2">
          ...
          <div className="flex flex-col gap-4">
            {filteredRooms.map((room) => (
              <div
                key={room.id}
                className="bg-[linear-gradient(135deg,rgba(255,255,255,0.95)_0%,rgba(214,235,255,0.65)_100%)] rounded-[20px] p-5 shadow-[0px_6px_10px_0px_rgba(0,0,0,0.18)] flex gap-4 items-center cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:shadow-[0px_10px_20px_0px_rgba(0,0,0,0.15)] active:scale-[0.98] active:translate-y-0 active:shadow-[0px_4px_8px_0px_rgba(0,0,0,0.1)]"
              >
